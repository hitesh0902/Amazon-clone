...
const products = [
  {
    id: 1,
    title: "Echo Dot– New and improved smart speaker with Alexa",
    price: 50.49,
    rating: 5,
  ...
  {
    id: 2,
    title: "Kindle Paperwhite - with Built-in Light, Waterproof, 8 GB, WiFi",
    price: 34.59,
    rating: 4,
  ...
  {
    id: 4,
    title: "Harry Potter and the Philosopher's Stone (limited edition).",
    price: 10.49,
    rating: 5,
  ...
  {
    id: 9,
    title: "Storite 15.6 Inch Laptop Backpack Bag (Dark Blue, 40 x 30x 12 cm)",
    price: 35.66,
    rating: 3,
    image:
  ...
  {
    id: 11,
    title: "Smartphone with Quad Camera, 4 GB RAM and 64 GB Storage",
    price: 199,
    rating: 4,
    image:
  ...
  {
    id: 12,
    title: "Lifelong Glass Top 3 Burner Gas Stove, Manual Ignition, Black",
    price: 64.99,
    rating: 3,
    image:
...
const HomeView = () => {
  return (
    <div className="root">
      <Navbar />
      <Homepage banners={banners} products={products} />
      <Footer />
    </div>
  );
};
